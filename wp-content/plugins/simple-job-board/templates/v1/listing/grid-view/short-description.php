 ...
 *
 * Override this template by copying it to yourtheme/simple_job_board/listing/v1/grid-view/short-description.php
 *
 * @author      PressTigers
...
if ('logo-detail' === get_option('job_board_listing') || 'without-logo' === get_option('job_board_listing')) {
    ...
    ================================= -->
    <?php
    echo get_simple_job_board_template('listing/grid-view/long-description.php');
    ?>
