...
<div class="section-title">
    <img src="<?php echo esc_url( plugin_dir_url(dirname(dirname(__FILE__))) . '/admin/images/simple-job-board-logo.png' );?>">
...
<!-- progressbar -->
<ul id="sjb-inactive">
    <li class="<?php echo esc_attr( $get_started )?>">
    ...
    <li class="<?php echo esc_attr( $get_ready ); ?>">
