...
class Simple_Job_Board_Settings_Init
{
    ...
    public function __construct()
    {
        ...
        // Check if Job Tags Settings Class Exists
        if (class_exists('Simple_Job_Board_Settings_Job_tags')) {

            // Initialize Job Tags Settings Class           
            new Simple_Job_Board_Settings_Job_tags();
        }
        /**
         * The class responsible for defining all the plugin uplaod file extensions settings that occur in the frontend area.
         */
